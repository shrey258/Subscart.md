...
<div style="flex: 1;">
  <img src="subscription_price_breakup.jpg" alt="Subscription Price Breakdown Screen" style="max-width: 100%;">
</div>
...
<div style="flex: 1;">
  <img src="delivery_timings.jpg" alt="Set Schedule & Delivery Timing Screen" style="max-width: 100%;">
</div>
...
<div style="flex: 1;">
  <img src="payment_selection.jpg" alt="Payment Selection Screen" style="max-width: 100%;">
</div>
...
<p>The <strong>Subscription Management</strong> screen provides users with an overview of their active meal subscription, allowing them to manage their orders and access their unique QR code for easy pickup.</p>
...
<div style="flex: 1;">
  <img src="customer_manage.jpg" alt="Subscription Management Screen" style="max-width: 100%;">
</div>
...
<p>The <strong>Meal Subscription Management</strong> screen allows users to customize their meal plan, change pickup details, and manage their scheduled meals effectively.</p>
...
<div style="flex: 1;">
  <img src="customer_manage_delivery.jpg" alt="Meal Subscription Management Screen" style="max-width: 100%;">
</div>
...
<p>The <strong>Custom Delivery Selection</strong> screen allows users to modify their meal delivery schedule based on their preferences. This Scren pops up when the user taps on the <strong>Custom Delivery</strong> button in the meal subscription management screen.</p>
...
<div style="flex: 1;">
  <img src="meal_management_pickup.jpg" alt="Custom Pickup Selection Screen" style="max-width: 100%;">
</div>
...
<p>The <strong>Staff Order Request & Status Update</strong> screen allows staff members to review incoming orders and take appropriate action within the designated lead time before the request expires. When the lead time gets over for the User, that's when the order pops up at the staff application</p>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Driver Home Screen</strong> displays the driver's current status and allows them to receive orders.</p>
  ...
  <div style="flex: 1;">
    <img src="driver_homepage.png" alt="Driver Home Screen" style="max-width: 100%;">
  </div>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Driver Order Receiving Screen</strong> displays new delivery requests that the driver can accept or reject.</p>
  ...
  <div style="flex: 1;">
    <img src="driver_recieve_order.png" alt="Driver Order Receiving Screen" style="max-width: 100%;">
  </div>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Driver Pickup Confirmation</strong> screen appears after the driver accepts an order and is en route to the pickup location.</p>
  ...
  <div style="flex: 1;">
    <img src="driver_pickup.jpg" alt="Driver Pickup Confirmation Screen" style="max-width: 100%;">
  </div>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Driver Delivery Confirmation</strong> screen appears when the driver reaches the delivery destination and needs to confirm the order handover.</p>
  ...
  <div style="flex: 1;">
    <img src="confirm_delivery.png" alt="Driver Delivery Confirmation Screen" style="max-width: 100%;">
  </div>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Delivery History</strong> screen displays a list of completed deliveries along with order details.</p>
  ...
  <div style="flex: 1;">
    <img src="delivery_history.jpg" alt="Delivery History Screen" style="max-width: 100%;">
  </div>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Completed Orders</strong> screen in the Customer Application displays a list of delivered items along with order details.</p>
  ...
  <div style="flex: 1;">
    <img src="customer_completed.jpg" alt="Completed Orders Screen" style="max-width: 100%;">
  </div>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 2; padding-right: 20px;">
    ...
    <p>The <strong>Delivery Agent Dashboard</strong> screen provides an overview of assigned jobs, customer details, and delivery requests.</p>
  ...
  <div style="flex: 1;">
    <img src="staff_completed.jpg" alt="Delivery Agent Dashboard" style="max-width: 100%;">
  </div>
